...
namespace Ringbuch
{
  public partial class MaterialBearbeiten : Form, MaterialBearbeitenInterface
  {
    ...
    private void Init()
    {
      ...
      InvokeMaterialByGruppeRequested("Pistole");
    }
    ...
    public void SetPistoleAll(DataTable dt)
    {
      comboPistole.DataSource = dt;
      comboPistole.DisplayMember = "Anzeige";
      comboPistole.ValueMember = "rowid";
    }
    ...
    private void MaterialDelete(object sender, EventArgs e)
    {
    ...
    private DataTable CreateDataTable(object sender)
    {
      ...
      string rowID = "-1";
      string material = (sender as Button).Name.ToLower().Remove(0, 3);
      material = material.Replace("insert", "");
      material = material.Replace("update", "");
      material = material.First().ToString().ToUpper() + material.Substring(1);
      switch ((sender as Button).Name.ToLower())
      {
        ...
        case "btnlgupdate":
          ...
          break;
        case "btnpistoleinsert":
        case "btnpistoleupdate":
          dt.Rows.Add(new object[]
          {
                        rowID,
                        "Pistole",
                        txtPistoleBezeichnung.Text,
                        txtPistoleLangtext.Text,
                        txtPistoleGroesse.Text
          });
          break;
      }
      return dt;
