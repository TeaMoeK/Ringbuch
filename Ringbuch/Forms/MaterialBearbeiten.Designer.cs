namespace Ringbuch
{
    partial class MaterialBearbeiten
    {
      ...
      this.txtPistoleLangtext = new System.Windows.Forms.TextBox();
      this.txtPistoleGroesse = new System.Windows.Forms.TextBox();
      this.txtPistoleBezeichnung = new System.Windows.Forms.TextBox();
      this.btnPistoleUpdate = new System.Windows.Forms.Button();
      this.btnPistoleDelete = new System.Windows.Forms.Button();
      this.btnPistoleInsert = new System.Windows.Forms.Button();
      ...
      this.btnHandschuhDelete.Click += new System.EventHandler(this.MaterialDelete);
      // 
      // btnJackeDelete
      // 
      ...
      this.btnJackeDelete.Click += new System.EventHandler(this.MaterialDelete);
      // 
      // btnJackeInsert
      // 
      ...
      this.btnKKDelete.Click += new System.EventHandler(this.MaterialDelete);
      // 
      // btnKKInsert
      // 
      ...
      this.btnLGDelete.Click += new System.EventHandler(this.MaterialDelete);
      // 
      // btnLGInsert
      // 
      ...
      // btnClose
      // 
      this.btnClose.Location = new System.Drawing.Point(14, 243);
      ...
      // groupTextBoxes
      // 
      this.groupTextBoxes.Controls.Add(this.txtPistoleLangtext);
      this.groupTextBoxes.Controls.Add(this.txtPistoleGroesse);
      this.groupTextBoxes.Controls.Add(this.txtPistoleBezeichnung);
      ...
      this.groupTextBoxes.Size = new System.Drawing.Size(331, 224);
      this.groupTextBoxes.TabIndex = 36;
      this.groupTextBoxes.TabStop = false;
      // 
      // txtPistoleLangtext
      // 
      this.txtPistoleLangtext.Location = new System.Drawing.Point(116, 193);
      this.txtPistoleLangtext.Name = "txtPistoleLangtext";
      this.txtPistoleLangtext.Size = new System.Drawing.Size(100, 20);
      this.txtPistoleLangtext.TabIndex = 37;
      // 
      // txtPistoleGroesse
      // 
      this.txtPistoleGroesse.Location = new System.Drawing.Point(222, 193);
      this.txtPistoleGroesse.Name = "txtPistoleGroesse";
      this.txtPistoleGroesse.Size = new System.Drawing.Size(100, 20);
      this.txtPistoleGroesse.TabIndex = 38;
      // 
      // txtPistoleBezeichnung
      // 
      this.txtPistoleBezeichnung.Location = new System.Drawing.Point(10, 193);
      this.txtPistoleBezeichnung.Name = "txtPistoleBezeichnung";
      this.txtPistoleBezeichnung.Size = new System.Drawing.Size(100, 20);
      this.txtPistoleBezeichnung.TabIndex = 36;
      // 
      // btnPistoleUpdate
      // 
      this.btnPistoleUpdate.Location = new System.Drawing.Point(559, 193);
      this.btnPistoleUpdate.Name = "btnPistoleUpdate";
      this.btnPistoleUpdate.Size = new System.Drawing.Size(75, 23);
      this.btnPistoleUpdate.TabIndex = 39;
      this.btnPistoleUpdate.TabStop = false;
      this.btnPistoleUpdate.Text = "Ändern";
      this.btnPistoleUpdate.UseVisualStyleBackColor = true;
      this.btnPistoleUpdate.Click += new System.EventHandler(this.MaterialUpdate);
      // 
      // btnPistoleDelete
      // 
      this.btnPistoleDelete.Location = new System.Drawing.Point(640, 193);
      this.btnPistoleDelete.Name = "btnPistoleDelete";
      this.btnPistoleDelete.Size = new System.Drawing.Size(75, 23);
      this.btnPistoleDelete.TabIndex = 40;
      this.btnPistoleDelete.TabStop = false;
      this.btnPistoleDelete.Text = "Löschen";
      this.btnPistoleDelete.UseVisualStyleBackColor = true;
      this.btnPistoleDelete.Click += new System.EventHandler(this.MaterialDelete);
      // 
      // btnPistoleInsert
      // 
      this.btnPistoleInsert.Location = new System.Drawing.Point(478, 193);
      this.btnPistoleInsert.Name = "btnPistoleInsert";
      this.btnPistoleInsert.Size = new System.Drawing.Size(75, 23);
      this.btnPistoleInsert.TabIndex = 38;
      this.btnPistoleInsert.TabStop = false;
      this.btnPistoleInsert.Text = "Hinzufügen";
      this.btnPistoleInsert.UseVisualStyleBackColor = true;
      this.btnPistoleInsert.Click += new System.EventHandler(this.MaterialInsert);
      // 
      // label4
      // 
      ...
      this.label4.Text = "Pistole";
      // 
      // comboPistole
      // 
      this.comboPistole.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comboPistole.FormattingEnabled = true;
      this.comboPistole.Location = new System.Drawing.Point(14, 193);
      this.comboPistole.Name = "comboPistole";
      this.comboPistole.Size = new System.Drawing.Size(121, 21);
      this.comboPistole.TabIndex = 37;
      this.comboPistole.TabStop = false;
      this.comboPistole.Tag = "Pistole";
      this.comboPistole.SelectedIndexChanged += new System.EventHandler(this.SelectionToTextBox2);
      // 
      // MaterialBearbeiten
      // 
      ...
      this.Controls.Add(this.btnPistoleUpdate);
      this.Controls.Add(this.btnPistoleDelete);
      this.Controls.Add(this.btnPistoleInsert);
    ...
    private System.Windows.Forms.TextBox txtPistoleLangtext;
    private System.Windows.Forms.TextBox txtPistoleGroesse;
    private System.Windows.Forms.TextBox txtPistoleBezeichnung;
    private System.Windows.Forms.Button btnPistoleUpdate;
    private System.Windows.Forms.Button btnPistoleDelete;
    private System.Windows.Forms.Button btnPistoleInsert;
